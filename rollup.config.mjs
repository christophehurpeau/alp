...
import configs8 from './packages/alp-node-language/rollup.config.mjs';
import configs9 from './packages/alp-router/rollup.config.mjs';
import configs10 from './packages/alp-translate/rollup.config.mjs';
