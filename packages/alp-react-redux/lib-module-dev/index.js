...
var OptionsType = t.type('OptionsType', t.exactObject(t.property('sharedReducers', t.nullable(t.object(t.indexer('key', t.string(), t.any()))), true), t.property('scriptName', t.union(t.nullable(t.string()), t.boolean(false)), true), t.property('styleName', t.union(t.nullable(t.string()), t.boolean(false)), true), t.property('polyfillFeatures', t.nullable(t.string()), true)));
            ...
            return regeneratorRuntime.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    version = t.string().assert(ctx.config.get('version'));
