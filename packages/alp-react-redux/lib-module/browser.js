            ...
            var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(App) {
              ...
              return regeneratorRuntime.wrap(function _callee2$(_context2) {
                for (;;) switch (_context2.prev = _context2.next) {
                  case 0:
                    return app = React.createElement(App), false, _context2.next = 4, preRender(app);

                  case 4:
                    moduleReducers = _context2.sent, store ? moduleStoreReducer.setReducers(moduleReducers) : store = createStore(ctx, moduleReducers), WrappedApp = createAlpAppWrapper(app, {
                      context: ctx,
                      store: store,
