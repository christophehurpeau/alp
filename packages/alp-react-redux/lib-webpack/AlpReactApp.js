  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(Helmet, {
        ...
        script: [{ src: 'https://polyfill.io/v2/polyfill.min.js?features=default,es6,localStorage,fetch,Intl&unknown=polyfill' }, false, { defer: '', src: assetUrl('/' + window.SCRIPT_NAME + '.js', version) }].filter(Boolean)
      }),
      children
    )
  );
