...
const LayoutOptionsType = exports.LayoutOptionsType = _flowRuntime2.default.type('LayoutOptionsType', _flowRuntime2.default.exactObject(_flowRuntime2.default.property('layoutBody', _flowRuntime2.default.nullable(_flowRuntime2.default.function())), _flowRuntime2.default.property('version', _flowRuntime2.default.string()), _flowRuntime2.default.property('scriptName', _flowRuntime2.default.union(_flowRuntime2.default.string(), _flowRuntime2.default.boolean(false))), _flowRuntime2.default.property('styleName', _flowRuntime2.default.union(_flowRuntime2.default.string(), _flowRuntime2.default.boolean(false))), _flowRuntime2.default.property('initialData', _flowRuntime2.default.nullable(_flowRuntime2.default.any())), _flowRuntime2.default.property('polyfillFeatures', _flowRuntime2.default.nullable(_flowRuntime2.default.string()))));
...
<html ${helmet.htmlAttributes.toString()}>
  <head>
    ...
    ${scriptName === false ? null : `<script>${`window.VERSION='${version}';window.__INITIAL_DATA__=${(0, _uneval2.default)(initialData)};`}</script>`}
