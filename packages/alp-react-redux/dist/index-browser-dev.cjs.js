...
var BrowserAppContainer = _interopDefault(require('alp-dev/BrowserAppContainer'));
...
var createAlpAppWrapper = (function (app, context) {
  ...
  return _temp2 = _class = function (_Component) {
    ...
    createClass(AlpAppWrapper, [{
      ...
      value: function render() {
        var _returnType2 = t.return(t.ref(Element));

        if (this.state.error) return _returnType2.assert(React__default.createElement(
          'div',
          null,
  ...
  }(React.Component), _class.propTypes = t.propTypes(PropsType), _class.childContextTypes = {
...
var createBrowserStore = (function (app, ctx, moduleReducer, _ref) {
  ...
  return redux.createStore(rootReducer, Object.assign({ ctx: ctx }, window.__INITIAL_DATA__), composeEnhancers(redux.applyMiddleware.apply(undefined, toConsumableArray(middlewares))));
});
...
var createModuleReducer = function createModuleReducer(reducers) {
  ...
  return reducers ? redux.combineReducers(reducers) : function () {
    var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    return state;
  };
};
...
var PropsType$1 = t.type('PropsType', t.exactObject(t.property('children', t.ref(Node))));
var AlpModule = (_temp = _class = function (_Component) {
  ...
  return AlpModule;
}(React.Component), _class.propTypes = t.propTypes(PropsType$1), _temp);
...
var createPureStatelessComponent = (function (Component) {
  return reactRedux.connect(null, null, mergeProps)(Component);
});
...
var PropsType$2 = t.type('PropsType', t.exactObject(t.property('children', t.ref(Node$1)), t.property('reducers', t.nullable(t.ref(ReducerDictionaryType$2)))));
...
var Props = t.type('Props', t.exactObject(t.property('children', t.ref(Node$2))));
...
var PropsType$3 = t.type('PropsType', t.exactObject(t.property('children', t.ref(Node$3))));


var AppContainer = (function (_arg) {
  var _returnType = t.return(t.ref(Element$1, t.string('div')));

  var _PropsType$assert = PropsType$3.assert(_arg),
      children = _PropsType$assert.children;

  return _returnType.assert(React__default.createElement(
    'div',
    null,
    children
  ));
...
var hydrateApp = function hydrateApp(App) {
  return reactDom.hydrate(React__default.createElement(App), document.getElementById('react-app'));
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return reactTreeWalker(React__default.createElement(PreRenderWrappedApp), moduleVisitor.visitor);
                    ...
                    return regeneratorRuntime.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            appElement = React__default.createElement(App);

                            appElement = React__default.createElement(BrowserAppContainer, {}, appElement);
                            _context2.next = 4;
...
exports.ReduxActionType = ReduxActionType;
exports.ReduxDispatchType = ReduxDispatchType;
exports.ReduxReducerType = ReduxReducerType;
exports.ReducerDictionaryType = ReducerDictionaryType;
