...
const Element = t.tdz(() => React.Element);
...
const Element$1 = t.tdz(() => React.Element);
...
const PropsType$1 = t.type('PropsType', t.exactObject(t.property('children', t.ref(Node))));
let AlpModule = (_temp = _class = class extends React.Component {
...
const PropsType$2 = t.type('PropsType', t.exactObject(t.property('reducers', t.nullable(t.ref(ReducerDictionaryType$1))), t.property('children', t.ref(Node$1))));
...
const Node$2 = t.tdz(() => React.Node);
const Props = t.type('Props', t.exactObject(t.property('children', t.ref(Node$2))));
...
const Element$2 = t.tdz(() => React.Element);
const Node$3 = t.tdz(() => React.Node);
const PropsType$3 = t.type('PropsType', t.exactObject(t.property('children', t.ref(Node$3))));
