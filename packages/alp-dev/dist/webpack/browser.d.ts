...
export declare const runDevServer: (compiler: PobpackCompiler, port: number, proxyPort: number, options?: Pick<RunOptions, "public" | "after" | "allowedHosts" | "bonjour" | "clientLogLevel" | "contentBase" | "disableHostCheck" | "filename" | "historyApiFallback" | "host" | "hotOnly" | "index" | "inline" | "lazy" | "noInfo" | "open" | "openPage" | "pfx" | "pfxPassphrase" | "publicPath" | "setup" | "socket" | "sockPath" | "staticOptions" | "stats" | "useLocalIp" | "watchContentBase" | "watchOptions" | "writeToDisk"> | undefined) => WebpackDevServer;
