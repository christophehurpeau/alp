...
export declare const runDevServer: (compiler: PobpackCompiler, port: number, proxyPort: number, options?: Pick<RunOptions, "host" | "public" | "open" | "setup" | "inline" | "watchOptions" | "stats" | "after" | "allowedHosts" | "bonjour" | "clientLogLevel" | "contentBase" | "disableHostCheck" | "filename" | "historyApiFallback" | "hotOnly" | "index" | "lazy" | "noInfo" | "openPage" | "pfx" | "pfxPassphrase" | "publicPath" | "socket" | "staticOptions" | "useLocalIp" | "watchContentBase" | "writeToDisk"> | undefined) => any;
