...
let watching = watchAndRun(nodeCompiler, argv__default.port);
process.on('SIGUSR2', () => {
  watching.close(() => {
    watching = watchAndRun(nodeCompiler, argv__default.port);
  });
});
//# sourceMappingURL=watch-node-node12-dev.cjs.js.map
