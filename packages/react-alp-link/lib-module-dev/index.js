...
var PropsType = t.type('PropsType', t.object(t.property('tagName', t.nullable(t.string())), t.property('to', t.string()), t.property('params', t.nullable(t.object())), t.property('children', t.nullable(t.any()))));
...
var LinkComponent = function LinkComponent(_arg, _arg2) {
  var _PropsType$assert = PropsType.assert(_arg),
      _PropsType$assert$tag = _PropsType$assert.tagName,
      TagName = _PropsType$assert$tag === undefined ? 'a' : _PropsType$assert$tag,
