...
function alpTranslate(dirname) {
  ...
  return _flowRuntime2.default.param('dirname', _dirnameType).assert(dirname), dirname = _dirnameType.assert(dirname.replace(/\/*$/, '/')), app => {
    Object.assign(app.context, {
      t(key, args) {
        ...
        _flowRuntime2.default.param('key', _keyType).assert(key), _flowRuntime2.default.param('args', _argsType).assert(args);
