...
var PropsType = _t.type('PropsType', _t.exactObject(_t.property('id', _t.string()), _t.property('as', _t.nullable(_t.null()), true), _t.property('children', _t.nullable(ChildrenCallbackType), true), _t.indexer('key', _t.string(), _t.any())));
