...
export const UserType = t.type("UserType", t.object(t.property("displayName", t.string()), t.property("fullName", UserNameType), t.property("status", t.string()), t.property("emails", t.array(t.string())), t.property("emailDomains", t.array(t.string())), t.property("accounts", t.array(AccountType))));
...
export const UserBrowserType = t.type("UserBrowserType", t.object(t.property("displayName", t.string()), t.property("fullName", UserNameType), t.property("status", t.string()), t.property("emails", t.array(t.string())), t.property("emailDomains", t.array(t.string())), t.property("accounts", t.array(AccountBrowserType))));
