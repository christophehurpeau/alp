...
Object.assign(mongoUsersManager, {
  findOneByAccountOrEmails(_arg) {
    ...
    let {
      ...
      accountId,
      emails
    } = t.object(t.property('provider', t.string()), t.property('accountId', t.union(t.string(), t.number())), t.property('emails', t.nullable(t.array(t.string())))).assert(_arg);
    ...
    }), this.store.findOne(query).then(_arg2 => _returnType.assert(_arg2));
  },
