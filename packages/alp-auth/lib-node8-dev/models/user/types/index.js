...
const UserType = exports.UserType = _flowRuntime2.default.type("UserType", _flowRuntime2.default.object(_flowRuntime2.default.property("id", _flowRuntime2.default.string(), true), _flowRuntime2.default.property("_id", _flowRuntime2.default.string(), true), _flowRuntime2.default.property("displayName", _flowRuntime2.default.string()), _flowRuntime2.default.property("fullName", UserNameType), _flowRuntime2.default.property("status", _flowRuntime2.default.string()), _flowRuntime2.default.property("emails", _flowRuntime2.default.array(_flowRuntime2.default.string())), _flowRuntime2.default.property("emailDomains", _flowRuntime2.default.array(_flowRuntime2.default.string())), _flowRuntime2.default.property("accounts", _flowRuntime2.default.array(AccountType))));
...
const UserBrowserType = exports.UserBrowserType = _flowRuntime2.default.type("UserBrowserType", _flowRuntime2.default.object(_flowRuntime2.default.property("id", _flowRuntime2.default.string(), true), _flowRuntime2.default.property("_id", _flowRuntime2.default.string(), true), _flowRuntime2.default.property("displayName", _flowRuntime2.default.string()), _flowRuntime2.default.property("fullName", UserNameType), _flowRuntime2.default.property("status", _flowRuntime2.default.string()), _flowRuntime2.default.property("emails", _flowRuntime2.default.array(_flowRuntime2.default.string())), _flowRuntime2.default.property("emailDomains", _flowRuntime2.default.array(_flowRuntime2.default.string())), _flowRuntime2.default.property("accounts", _flowRuntime2.default.array(AccountBrowserType))));
