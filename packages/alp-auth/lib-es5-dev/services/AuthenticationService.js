...
var logger = new _nightingaleLogger2.default('alp-auth.services.authentication');
                ...
                case 'oauth2':
                    {
                        var _ret = function () {
                            ...
                            return {
                                v: (0, _promiseCallbackFactory2.default)(function (done) {
                    ...
                    while (1) {
                        switch (_context.prev = _context.next) {
                            ...
                            case 8:
                                ...
                                _context.next = 11;
                                return (0, _generators.randomHex)(8);
